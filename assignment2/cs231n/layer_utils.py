...
# Similar to the affine and relu layers we implemented before
def affine_batchnorm_relu_forward(x, W, b, gamma, beta, batchnorm_param):
  fc_out, fc_cache = affine_forward(x, W, b)
  bn_out, bn_cache = batchnorm_forward(fc_out, gamma, beta, batchnorm_param)
...
# Similar to Batch Normalization: Layer Normalization
def affine_layernorm_relu_forward(x, W, b, gamma, beta, layernorm_param):
  fc_out, fc_cache = affine_forward(x, W, b)
  ln_out, ln_cache = layernorm_forward(fc_out, gamma, beta, layernorm_param)
